        ...
        <Routes>
            ...
            <Route element={<ProtectedRoute />}>
                <Route element={<AppShell />}>
                    ...
                    <Route
                        path="/studio/albums/new"
                        element={<NewAlbumPage />}
                    />
                    <Route
                        path="/studio/albums/:albumId"
                        element={<AlbumWorkshopPage />}
                    />
                    <Route
                        path="/studio/albums/:albumId/share"
                        element={<SharePage />}
                    />
                    <Route
                        path="/studio/albums/:albumId/settings"
                        element={<AlbumSettingsPage />}
                    />
                </Route>
            </Route>
            <Route
